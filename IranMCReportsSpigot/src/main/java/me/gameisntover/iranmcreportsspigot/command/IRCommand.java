...
public abstract class IRCommand extends Command implements PluginIdentifiableCommand {
    ...
    protected IRCommand(String name, String description, PermissionDefault permissionDefault) {
        super(name);
        ...
        commandMap.register("iranminecraft", this);
    ...
    public Plugin getPlugin() {
        return IranMCReportsSpigot.getInstance();
    }
