package me.gameisntover.iranmcreportsspigot.database;
...
public class TicketDatabase extends Database {
    public final DBObject<String> ticketId = DBObject.of("id", "LONG", true, false);
    ...
    public TicketDatabase() {
        super(config().getDatabaseInfo("ticket-database"));
        createNewTable(tableName, ticketId, creator, lore, status, dateCreated,time,type);
    }
